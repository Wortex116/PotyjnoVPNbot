...
# ... остальные обработчики (user_action_menu, block/unblock, prolong, remove, фильтры, топ и т.д.) остаются без изменений, только заменяют sqlite3 на get_db_connection()
